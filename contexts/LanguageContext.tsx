...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "categories.confirmDelete": "Are you sure you want to delete this category?",
           ...
           "inventory.emptyStock": "Empty Stock",
           "inventory.totalItems": "Total Items",
           "inventory.selectProduct": "Select a product",
           "inventory.locationPlaceholder": "e.g., Aisle 1, Shelf A",
           "inventory.inventoryAddedSuccess": "Inventory added successfully!",
           "inventory.failedToAddInventory": "Failed to add inventory",
           "inventory.errorAddingInventory": "An error occurred while adding inventory",
           "inventory.searchProductPlaceholder": "Search product by name or SKU...",
           "inventory.quantityPlaceholder": "Enter quantity",
           "inventory.productId": "Product ID",
           "inventory.items": "items",
           "inventory.productNameSkuFallback": "You can also use 'product' column with product name or 'sku' with SKU, it will be mapped to product_id if found.",
           "inventory.bulkUploadSuccess": "Bulk upload successful! {{count}} added.",
           "inventory.failedToUploadInventory": "Failed to upload inventory",
           "inventory.errorUploadingInventory": "An error occurred while uploading inventory",
           "inventory.store": "Store",
           "inventory.selectStore": "Select store",
           "inventory.singleEntry": "Single Inventory",
           "inventory.bulkUpload": "Bulk Upload Inventory",
           "inventory.chooseFile": "Choose File",
           "inventory.expectedFormat": "Expected format",
    ...
    "cashier.checkout": "Checkout",
           ...
           "cashier.noProductsAvailable": "No products available with valid inventory",
           "cashier.insufficientInventory": "Insufficient inventory. Available: {{available}}, Requested: {{requested}}",
           "cashier.saveCart": "Save Cart",
           "cashier.updateCart": "Update Cart",
           "cashier.loadCart": "Load Cart",
           "cashier.cartName": "Cart Name",
           "cashier.cartNamePlaceholder": "Enter cart name...",
           "cashier.cartSaved": "Cart saved successfully!",
           "cashier.cartUpdated": "Cart updated successfully!",
           "cashier.failedToSaveCart": "Failed to save cart",
           "cashier.confirmDeleteCart": "Are you sure you want to delete this cart?",
           "cashier.noSavedCarts": "No saved carts",
           "cashier.items": "items",
           "cashier.savedAs": "Saved as",
           "cashier.cartEmpty": "Cart is empty. Add items before saving.",
           "cashier.orderCreatedSuccess": "Order created successfully!",
           "cashier.failedToCreateOrder": "Failed to create order. Please try again.",
           "cashier.clearCart": "Clear Cart",
           "cashier.newCart": "New Cart",
           "cashier.confirmNewCart": "Create a new cart? Current cart will be cleared.",
           "cashier.confirmLoadCart": "Load this cart? Current cart will be replaced.",
  ...
  in: {
    ...
    "categories.confirmDelete": "Apakah Anda yakin ingin menghapus kategori ini?",
           ...
           "inventory.emptyStock": "Stok Kosong",
           "inventory.totalItems": "Total Item",
           "inventory.selectProduct": "Pilih produk",
           "inventory.locationPlaceholder": "contoh: Aisle 1, Shelf A",
           "inventory.inventoryAddedSuccess": "Inventori berhasil ditambahkan!",
           "inventory.failedToAddInventory": "Gagal menambahkan inventori",
           "inventory.errorAddingInventory": "Terjadi kesalahan saat menambahkan inventori",
           "inventory.searchProductPlaceholder": "Cari produk berdasarkan nama atau SKU...",
           "inventory.quantityPlaceholder": "Masukkan jumlah",
           "inventory.productId": "ID Produk",
           "inventory.items": "item",
           "inventory.productNameSkuFallback": "Anda juga dapat menggunakan kolom 'product' dengan nama produk atau 'sku' dengan SKU, akan dipetakan ke product_id jika ditemukan.",
           "inventory.bulkUploadSuccess": "Unggah massal berhasil! {{count}} ditambahkan.",
           "inventory.failedToUploadInventory": "Gagal mengunggah inventori",
           "inventory.errorUploadingInventory": "Terjadi kesalahan saat mengunggah inventori",
           "inventory.store": "Toko",
           "inventory.selectStore": "Pilih toko",
           "inventory.singleEntry": "Inventori Tunggal",
           "inventory.bulkUpload": "Unggah Massal Inventori",
           "inventory.chooseFile": "Pilih File",
           "inventory.expectedFormat": "Format yang diharapkan",
    ...
    "cashier.checkout": "Checkout",
           ...
           "cashier.noProductsAvailable": "Tidak ada produk tersedia dengan inventori yang valid",
           "cashier.insufficientInventory": "Inventori tidak mencukupi. Tersedia: {{available}}, Diminta: {{requested}}",
           "cashier.saveCart": "Simpan Keranjang",
           "cashier.updateCart": "Perbarui Keranjang",
           "cashier.loadCart": "Muat Keranjang",
           "cashier.cartName": "Nama Keranjang",
           "cashier.cartNamePlaceholder": "Masukkan nama keranjang...",
           "cashier.cartSaved": "Keranjang berhasil disimpan!",
           "cashier.cartUpdated": "Keranjang berhasil diperbarui!",
           "cashier.failedToSaveCart": "Gagal menyimpan keranjang",
           "cashier.confirmDeleteCart": "Apakah Anda yakin ingin menghapus keranjang ini?",
           "cashier.noSavedCarts": "Tidak ada keranjang tersimpan",
           "cashier.items": "item",
           "cashier.savedAs": "Disimpan sebagai",
           "cashier.cartEmpty": "Keranjang kosong. Tambahkan item sebelum menyimpan.",
           "cashier.orderCreatedSuccess": "Pesanan berhasil dibuat!",
           "cashier.failedToCreateOrder": "Gagal membuat pesanan. Silakan coba lagi.",
           "cashier.clearCart": "Bersihkan Keranjang",
           "cashier.newCart": "Keranjang Baru",
           "cashier.confirmNewCart": "Buat keranjang baru? Keranjang saat ini akan dibersihkan.",
           "cashier.confirmLoadCart": "Muat keranjang ini? Keranjang saat ini akan diganti.",
